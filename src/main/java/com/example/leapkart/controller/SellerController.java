...
public class SellerController {
    ...
    public ResponseEntity<List<SellerResponse>> getSellerById(@PathVariable("gender") Gender gender)
    {
        List<SellerResponse> responseList= sellerService.getSellerById(gender);
